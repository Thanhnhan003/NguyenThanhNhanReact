      ...
      <div id="myCarousel" className="carousel slide homCar">
        <div className="carousel-inner">
          <div className="item active">
            <img
              style={{ width: "100%" }}
              src="shop/assets/img/bootstrap_free-ecommerce.png"
          ...
          <div className="item">
            <img
              style={{ width: "100%" }}
              src="shop/assets/img/carousel1.png"
              alt="bootstrap ecommerce templates"
            />
            <div className="carousel-caption">
          ...
          <div className="item">
            <img
              style={{ width: "100%" }}
              src="shop/assets/img/carousel3.png"
              alt="bootstrap ecommerce templates"
            />
            <div className="carousel-caption">
          ...
          <div className="item">
            <img
              style={{ width: "100%" }}
              src="shop/assets/img/bootstrap-templates.png"
